...
foreach($data as $d){
  ...
  switch ($d['matkul']){
    case '1': $matkul="Informatika"; break;
    case '2': $matkul="Arsitektur"; break;
    case '3': $matkul="Ilmu Lingkungan"; break;

    default:
      $matkul="Tidak Diketahui";
      break;
  }
  echo"<tr><td>NIDN</td><td><input type='number' name='nidn' value='$d[nim]' class='form-control'></td></tr>";
  ...
  echo"<tr><td>MATA KULIAH</td><td><select name='matkul' class='form-control'>
                    <option></option>
                    <option value='1'"; if($d['matkul']==1) {echo "selected";}echo">Informatika</option>
                    <option value='2'"; if($d['matkul']==2) {echo "selected";}echo">Arsitektur</option>
                    <option value='3'"; if($d['matkul']==3) {echo "selected";}echo">Ilmu Lingkungan</option>
  </select></td></tr>";
  echo"<tr><td></td><td>
