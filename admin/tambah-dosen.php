...
if($_POST['simpan']){
  ...
  $sql="insert into dsn set nidn='$nidn', nama='$nama', gender='$jk', alamat='$alamat', matkul='$matkul', waktu='$waktu'";
  $tes=$db->query($sql);
  if($tes){
        ...
        <tr>
            ...
            <td>
                <select name="matkul" class="form-control">
                    <option></option>
                    <option value="1" <?php if($matkul==1) echo "selected";?>>Informatika</option>
                    <option value="2" <?php if($matkul==2) echo "selected";?>>Arsitektur</option>
                    <option value="3" <?php if($matkul==3) echo "selected";?>>Ilmu Lingkungan</option>
                </select>
            </td>
        </tr>
        <tr>
